...
label ch4_exclusive_sayori:
    "I go over to help Sayori as discussed yesterday."
    ...
    s "Aren't you supposed to help one of the others today?"
    mc "Yeah, but..."
    ...
    mc "Ah, that's true..."
    mc "Well, there was a change of plans."
    mc "They let me come over to help you out today."
    ...
    mc "Well, everyone wanted me to help you out, anyway." 
    mc "Monika can handle it on her own; but they wanted us to work together."
    s 1bv "Oh? On what?"
    mc "Monika said she wanted us to try preforming poems together, to get us both prepped."
    mc "You think you can do that?"
    s "Y-Yea, I guess."
    s 2bg "Just... go easy on me, alright?"
    mc "I have no doubt, Sayori."
    "She walks off, and pulls one of her poems out from her bag."
    "She begins reciting it to me."
    "The delivery’s really strong, and her tone compliments the piece." 
    "Even if I don't enjoy her more somber attitude, it works to make the poem more enjoyable."
    "However, when she’s done, she questions me."
    s 2bf "[player]… I don’t think I can do this to an audience."
    mc "Why couldn’t you?"
    s 2bp "Because, what if I mess up and they all laugh at me?"
    mc "Sayori, that’s just it." 
    mc "Who cares if they laugh at you?"
    mc "They’re strangers!" 
    mc "They’re not your friends, so what they think doesn’t matter."
    s "But it’ll be really embarrassing…"
    mc "That’s only because of how you make it." 
    mc "Sayori, I believe in you, you won't mess up." 
    mc "Even if you do, the people who laugh at you don’t matter."
    mc "It’s the people who’ll be there for you in spite of those who laugh."
    mc "You remember 5th grade, Sayori?"
    mc "When... the {i}incident{/i} took place and everyone laughed?"
    mc "Who was there for me, then?"
    s 2bt "I was…"
    mc "Right, and did you make me feel better about that?"
    s 1bu "I… I hope so…"
    mc "Don’t hope so, because you did." 
    mc "And if you mess up, it’ll be the same way here." 
    mc "Don’t worry about it, alright?"
    s 1bt "Well, alright."
    s "Thank you, [player]."
    ...
    s "I'm not going anywhere, ever again."
    s "All I managed to do right now is rope you into my problem, make {i}you{/i} feel worse."
    s "I just succeeded in creating a bigger problem than before..."
    mc "Sayori..."
    ...
    menu:
        ...
        "I love you.":
            ...
            s "But, I do love you, too..."
            s "Besides, You know what's best for me..."
            mc "...Yeah."
            mc "I do."
        ...
        "You'll always be my dearest friend.":
            ...
            hide sayori
            "..."
            "Alright, you know what, I'll give you a pass on this one."
            "Everyone has a different idea of the best answer to this, so it's not surprising that you might have chosen this."
            "But, uh, this mod was meant to let you date the Dokis, so..."
            "You were expected to go for the other answer..."
            "Ack, forget it, I'll just give you the alternative."
            "Here."
            scene bg house
...
label ch4_exclusive_natsuki:
    ...
    mc "We could make it more literature-themed by shaping them like books."
    n 1bq "Uu..."
    mc "Hm?"
    ...
    n 1bh "I've felt it..."
    n "For a while now..."
    n "I... I like you, [player]. In {i}that{/i} way."
    "I'm taken aback."
    "Natsuki? Likes me?"
    "I really have no idea how to respond."
    ...
    menu:
        ...
        "Confess.":
            mc "I, I feel it too."
            mc "I mean, between us."
            n 2bq "Yea..."
            "..."
            "Awkwardness fills the air."
            "I speak up, slightly nervous."
            mc "So..."
            mc "The festival is our first date, huh?"
            "She perks up a bit."
            n "Yea, I guess!"
            "She giggles."
        ...
        "Reject her.":
            ...
            "What?"
            "This is- the fuck-"
            "You literally downloaded this to date the Dokis you fucking shitbrain."
            "Why the fuck did you choose no?"
            "Did you misclick or something?"
            "Fucking hell."
            "This is normally the part of the game where I take you back so you can do it right."
            "But fuck that shit, I'm not doing that just for some dumbass who cant click the clearly fucking correct choice."
            "I hope you saved before that shit, or that you know what the skip button does."
            "Fucking asshole."
            "..."
            "..."
            "..."
            "..."
            "..."
            "Alright, fuck it, you know what?"
            "I'll just play this garbage as if you said yes."
            "This is me doing you a favor, by the way."
            "Just don't fuck up the next segment."
            "Seeing as your brain is about the size of your tic-tac dick, you probably will."
            "But for fucks sake, at least {i}try{/i} this time?"
            "..."
            "Dumbass."
            scene bg house
            show natsuki 1bh at t11 zorder 2
...
label ch4_exclusive_yuri:
    ...
    y "I kind of like a lot of things about you, in fact."
    y 2bq "I really am in love with you, aren't I?"
    "She says that mostly to herself, but I heard it myself loud and clear. She looks at me."
    y 3bp "I didn't... say that out loud, did I?"
    mc "You did."
    "She looks down, embarassed. Once again, I have to save the situation."
    ...
    menu:
        ...
        "Admit to her":
            mc "Don't worry."
            mc "In truth, I like you, as well."
            mc "Ever since I joined the literature club, spending time with you has been really special."
            mc "I wouldn't skip on it for the world."
            y 2bo "Y-you really mean that?"
            mc "I do."
            mc "And, hey, I'll prove it."
            mc "The festival, tomorrow?"
            mc "How about making that our first date?"
            "She gasps."
            y "[player], that..."
            y 2bu "Makes me so happy..."
            mc "Good."
...
label ch4_exclusive_monika: 
    ...
    m "Green or orange here?"
    mc "It’s a blue poster, so orange is probably your best bet."
    "She takes the orange glitter, and the glue, and sprinkles it all over the poster." 
    "She puts it in the \"Finished\" pile and grabs a new poster." 
    "As she begins working I realize there’s still 20 more posters left after this one in the pile."
    mc "How many of these will we need, exactly?"
    m 1bn "Getting impatient, huh?"
    m 4bj "Don’t worry, we only need about 10 more."
    m 2bo "Hmmm... We could probably get it done quicker if we both worked on them at the same time."
    "I mentally kick myself for not thinking of that, grab a blank poster and stare at it for a bit." 
    "I remember why I offered to help her and not do it myself." 
    "After a few minutes, she notices this."

    m 2bn "You need some help, [player]?"
    mc "Sorry." 
    mc "I don’t really have ANY idea what to do here."
    m 1be "Look, It’s easy."
    "She forms an \"L\" with the glue." 
    "Then an \"i\", then a \"t\"."
    m 1bb "See? Here, you try."
    "I attempt to create an e, but it looks more like a mauled smiley-face."
    m "Here, look."
    "She gets behind me, grabs my hands, and helps me direct the glue bottle." 
    "It’s only about a minute before she realizes what’s going on and jumps away."
    m 1bp "Sorry! Sorry! I didn’t mean to do that, sorry!"
    "Monika's face turns bright red. She starts panicking, and she takes a few steps back."

    "I realize it’s up to me to save the situation."
    mc "Hey, it’s alright."
    mc "You were just helping me out, that’s all."
    m 1bq "Y-yeah. You’re right, I guess. You think you got it now though, [player]?"
    mc "Yep. I think I’ll be good. Thank you for the help."

    "With that, she turns back to her poster, cheeks bright red." 
    "I turn back to mine, write out the rest of \"literature club\", put glitter on, and show it to her."
    m 1ba "See! That’s really nice! Everyone can improve with a little help from a friend!"
    mc "Thank you, Monika. That’s really nice of you."
    m "Ahaha, don’t mention it." 
    m 4bb "Let’s just continue with the posters, alright?"
    "I thank her and set the poster down." 
    "I’m a bit into the next one when I get a text from Sayori." 
    "She’s asking how we’re doing." 
    "I tell her about how we’re getting the posters done together."
    "Monika notices this."
    m 1bh "God, Sayori. Does she HAVE to interrupt everything?"
    mc "Sayori? Do you not like her, or something?"
    ...
    mc "Are you... jealous, Monika?"
    m 1bl "Ahaha, no, not at all! Of Sayori?"
    m "No, definitely not..."
    "She lacks confidence in that statement. I turn back to our posters."
    "When we finish with all of them, we take time to marvel at our work."
    m 1ba "Well, that's it then, huh?" 
    m 4ba "I supposed that's my cue to pack my stuff...?"
    ...
    "I’m shocked. Monika? Like me? Is this some kind of joke?"
    m 1bp "I was thinking… well, you know… we... could date?"
    "Oh my god, it’s real! I take a minute to gather my thoughts."
    "What should I say?"
    menu:
        mc "Monika..."
