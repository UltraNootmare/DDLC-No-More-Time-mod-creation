...
label monikaroute:
    ...
    n "{i}I just hope that everyone else is as impressed by them as much as you guys are.{/i}"
    show natsuki 5s
    ...
    "I ask, sitting down."
    m 1b "Yea, but she’s out today." 
    m 2l "It’d probably be completely boring without SOMEONE sitting here."
    ...
    m 2p "You’re not doing the same, right?"
    mc "No, not at all."
    ...
    m 5a "Anyway, have you finished your project yet?"
    "Oh yea, that." 
    ...
    m 2i "I’d be impressed if that wasn’t two point seven five slides."
    #quick maffs 
    ...
    m 2e "Shooting Mecha Hitler?" 
    "She asks, smiling."
    mc "Hey, it’s a fun game, alright?"
    mc "Have you even played a video game before?"
    m 2d "I don’t have the time to spend all day on them..." 
    m 3e "and clearly I’m not as big a fan of them as you are..."
    m 3a "But I’ve played three or four of them." 
    m 3k "Besides, if I didn’t play video games, how would I know about Mecha Hitler?" 
    "She makes a point." 
    mc "Alright, I stand corrected." 
    mc "Why’d you get so judgmental about it then?"
    m 2h "I wasn’t." 
    m 2g "Sorry if it came out that way."
    m 2e "I just thought it was funny that’s what you spent your time doing."
    ...
    m 2c "Turn around and activate that corner over there." 
    m 5a "It’ll take you to a secret level."
    ...
    menu:
        ...
        "Volunteer.":
            ...
            m 2k "[player], you’re the best boyfriend ever!" 
            m "Seriously, thanks!"
            ...
            m 1a "I promise, I will make this up to you."
            m 1b "Thank you so much."
        ...
        "Refuse.":
            ...
            "She sighs."
            m 1r "I guess I can’t blame you."
    ...
    m 3bk "Come on, I’m sure if we put our heads together we can think of something!"
    mc "I… hmm…"
    ...
    m 2bp "I don’t really know." 
    m 3bm "Here, let me flip through the channels, see if I find something." 
    m 3bb "Unless you want to watch something, yourself."
    ...
    menu:
            ...
            "Watch the movie.":
                ...
                m 1bd "Aww, [player], you’re scared, aren’t you?"
                m 3be "That’s nothing to be ashamed about." 
                m 1bc "Come here."
                ...
                m "… I don’t mind." 
                m 1bf "If you’re scared, that’s fine." 
                m 3be "Lots of people get scared about this kind of thing." 
                m 2bk "I’ll protect you, don’t worry!"
                ...
                m 2bb "I do too!" 
                m 2bk "And the movie makes it even better~!"
    ...
    menu:
            ...
            "An Ultra-violent shooter.":
                ...
                m 2bp "Bye, [player]."
                m 2bn "Something different next week, huh?"
            ...
            "A Player vs Player game.":
                ...
                m 2bk "Come on, [player], you’re better than this, right?" 
                "Is she taunting me?"
                mc "I’m just going easy on you."
                mc "If you want, I can hold nothing back."
                m 1bb "Ooh, I like a challenge, [player]." 
                "Let’s do that."
                "I happily oblige her." 
                "Within minutes, I reach the frag limit." 
                "Monika's trailing behind with a whopping 7."
                "I smile at her, smug."
                m 1ba "Wow, I thought you were going to be good at this, [player], but good job." 
                m 1ba "I don’t want you to start going easy, though." 
                m 3bb "I’ll beat you, with my own skill alone!"
                ...
                m 4bk "Yes! And that’s how you get good, [player]!"
                "I laugh."
                mc "Nice work." 
                ...
                m 2bm "Can {i}you{/i} do that, though?"
                mc "Me? I don’t really know, I haven’t had to adapt to much…"
                m 2bk "Let’s test that out, then." 
                ...
                m 1bj "Hmm, this is kind of uncomfortable." 
                ...
                m 3bk "I’m tired, [player], I need someone to hold me up~" 
                ...
                m 1bk "We still have a match to finish!" 
                m 1bj "And hey, I’ll play fair for the rest of it."
                mc "..." 
                ...
                m 2be "[player]… Seriously, that was great."
                m "Thank you so much."
    ...
    m 3bi "Yeah, but taking care of yourself is no use." 
    m "Why else we would we have doctors?"
    m 2bh "Now come on, let me help you."
    ...
    menu:
            ...
            "Let Monika in.":
                ...
                m 1be "Don’t go anywhere!"
                "Before I can mention that I can’t really go anywhere, she leaves." 
                "A few minutes later, she arrives back with some coffee."
                m 3be "I think this is how you like it, right?"
                m 2bj "You left all of this on the counter, so I assume you were gonna make it before you answered the door."
                ...
                m 1ba "Ahaha, no need to stress out over it." 
                m "I’m just teasing you."
                m 3bn "Besides, I already knew you were like this." 
                m 2bk "Not only are you a teenage boy, but I can tell by the way you look at me sometimes."
                ...
                m 2bg "[player]…" 
                m 2be "I’m glad I was able to help you out." 
                ...
                m 2bd "Well, I’ve gotta go then."
                m "Bye, [player]."
                m 3be "Feel better!"
                mc "I’ll feel better as long as YOU don’t get sick."
                m "That work?"
                m 1ba "Yeah, I won’t be sick, promise." 
                m 1bb "See you tomorrow!" 
    ...
    m 2bf "Cold out this time of year, isn’t it?"
    ...
    m 1bo "Are you not going to join me, [player]?"
    mc "Uh… I mean… if you want me to?"
    m 1ba "That’s why I’m inviting you over, silly. Come on!"
    ...
    m 2bl "We can, sometime."
    m 1be "For now, why don’t you join me here? I don’t mind sharing!"
    ...
    "She beams."
    m 3bk "I really love this blanket, [player]."
    m 3bj "Reminds me of you!"
    ...
    if MonikaVar >= 3:
        ...
        m 3br "So I thought even if our relationship is on a higher level, you might still like her more."
        mc "Monika, trust me."
        ...
        m 1bm "I love you, too. I’m… sorry I didn’t trust you on this."
        m 1ba "I was… just a bit scared, is all."
        ...
        m 3bl "I mean, when two people really love each other, and they start making out, normally something comes after it…"
