...
label ch3_end:
    ...
    "More than that...she's looking forward to it."
...
label ch3_end_sayori:
    ...
    show natsuki at t31 zorder 2
    mc "N-No!"
    mc "Monika, is it much to ask that... you get this done yourself?"
    mc "I'm... really, really worried about Sayori."
    mc "I want to go talk to her and find out what's wrong tomorrow."
    mc "I'm sorry if that disappoints everyone."
    show natsuki 5q at t31 zorder 3
    show monika 2o at t32 zorder 2
    show yuri 3o at t33 zorder 4
    "All 3 girls look down, seemingly ashamed."
    m "Maybe [player] is right."
    m "You both CAN handle your own projects, right?"
    m "Even without Sayori's help, I'll be good with mine."
    "She turns to me."
    m 2i "You take care of Sayori, alright?"
    m "We all want to see her okay, don't we?"
    show natsuki at t31 zorder 4
    show monika at t32 zorder 3
    show yuri at t33 zorder 2
    y "Yes. She's an important member of the club, and beyond that, our friend."
    show natsuki at t31 zorder 2
    show monika at t32 zorder 4
    show yuri at t33 zorder 3
    n 1q "[player]..."
    n "You better make sure she's alright!"
    n 12f "If she... oh god, if she..."
    n "Don't let her, okay?"
    "Natsuki begins to cry."
    "If she what?"
    ...
    m 4o "In any case, go spend your Sunday with Sayori."
    m "We'll all be fine."
    m 2q "God, a rather somber note to end things on, but there's really nothing else to discuss."
    m "Club is adjourned."
    hide natsuki
    hide monika
    hide yuri
    "Natsuki, Monika, and Yuri head out."
    "I'm left to myself."
    "I begin to think about Sayori."
    "Was Natsuki right?"
    "Would Sayori really kill herself?"
    "God, I hope not."
...
label ch3_end_monika:
    ...
    show natsuki at t31 zorder 2
    show monika 1p at f32 zorder 3
    mc "Guys. I have more agency than just going along with something because she said so." 
    mc "Besides, I’m sure Sayori can help one of you two herself."
    mc "This will probably be really important."
    mc "I should help Monika with it, at the very least."
    "Yuri realizes what her words implied, and a look of remorse comes over her face."
    y 2l "You’re right."
    ...
    n "Yeah? Well I think you’re giving him too much!"
    ...
    m 2d "Speaking of which, do you have supplies for this?"
    mc "Yeah, I should."
    m 1j "Then, it’s settled. We’ll meet at your house. See ya Sunday!"
    "Before I have a chance to ask why we’re meeting at my house, she walks off." 
    "I contemplate texting her to ask, but eventually I just shrug it off and walk home." 
    return
