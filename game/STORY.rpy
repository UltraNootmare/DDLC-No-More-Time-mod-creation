label STORY:
    ...
    m 2n "Also how do you not remember that. You even said 'make sure to catch me' and 'everythings going black' before you fell?"
    show monika 2o at t33 zorder 1 
    mc "I don't really remember anything from today and if i was hurt that bad why didn't you call an ambulance"
    m 2n "hehe"
    show monika 2o at t33 zorder 1 
